...
class Daan:
    def __init__(self, username, password):
        ...
        Args:
            username (str): username (national code) for login in daan
            password (str): password for login in daan
        """
    ...
    def login(self):
        ...
        self.driver.find_element(
            by=By.XPATH, value='//*[@id="identificationNumber"]').send_keys(self.username)
        self.driver.find_element(
            by=By.XPATH, value='//*[@id="password"]').send_keys(self.password)
